function p = angToP_static(theta)
...
sInd_car = [-0.03 -0.0 0.024];    % rack1
sMid_car = [-0.03 -0.02 0.024];
sRin_car = [-0.03 -0.04 0.024];
sPin_car = [-0.03 -0.06 0.024];
sPos = sInd_car;
...
p = sPos - [(1*(finger_0*sin(pi/2.) + finger(1)*sin(pi/2-thetaS(1)) +...              % x

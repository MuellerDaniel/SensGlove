...
lb = [index(1)-0.004; index(2)-0.005; index(3)-0.005;...
        middle(1)-0.004; middle(2)-0.005; middle(3)-0.005;...
        ring(1)-0.004; ring(2)-0.005; ring(3)-0.005;...
        pinky(1)-0.004; pinky(2)-0.005; pinky(3)-0.005];        
ub = [index(1)+0.004; index(2)+rInd+0.005; index(3)+rInd+0.005;...
        middle(1)+0.004; middle(2)+rMid+0.005; middle(3)+rMid+0.005;...

...
'''
Displaying the sensor data in real time with pyqtgraph
'''
...
proc = subprocess.Popen("gatttool -t random -b E7:00:30:16:CD:18 --char-write-req --handle=0x000f --value=0100 --listen".split(),

...
'''
Comparing different minimization methods with simulated magnetic data
'''
...
plo.plotter2d((simValues_A[:,:3],simValues_A[:,3:6]),
              ("perfect angles index","middle"))
...
for i in range(0,2):
    ...
    plo.plotter2d((estAng_dip[:,:2], estAng_dip[:,2:4]),
...
#             ("model: dip without Adduction index","middle"+methString,"ring","pinky"))
    ...
    plo.plotter2d((estAng_cyl[:,:2], estAng_cyl[:,2:4]),

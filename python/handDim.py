...
# sensor positions radial 
#     [lateral(z(sensor_x)), radial[x_ulnar(sensor_-y),x_dorsal(sensor_+z)]]
sInd_rad = [0.03,            [0,                0.024]]     # rack1
sMid_rad = [0.03,            [0.02,             0.024]]
sRin_rad = [0.03,            [0.04,             0.024]]
sPin_rad = [0.03,            [0.06,             0.024]]
...
# joint positions radial
#        [lateral(z), [x_ulnar(sensor_-y),x_dorsal(sensor_+z)]]
jointInd_rad = [0.0,             [0,                    0.0]]
jointMid_rad = [0.0,             [0.02,                    0.0]]
jointRin_rad = [0.0,             [0.04,                    0.0]]
jointPin_rad = [0.0,             [0.06,                    0.0]]

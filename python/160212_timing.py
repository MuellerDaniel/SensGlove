...
plt.legend()
plt.text(0.15, 100, r'$\mu_{25Hz}$=0.08s $\rightarrow f=12.5\mathrm{Hz}$ ', color='green')
plt.text(0.15, 90, r'$\sigma_{25Hz}$=1.5e-06', color='green')
plt.text(0.15, 70, r'$\mu_{50Hz}$=0.05s $\rightarrow f=20\mathrm{Hz}$', color='blue')
plt.text(0.15, 60, r'$\sigma_{50Hz}$=2.0e-06', color='blue')
plt.xticks(np.arange(0,0.35,0.03))

...
sInd2 = np.array([-0.02-0.02,  -0.009, 0.030])      # for 160210 NEAR to joints
...
plt.savefig("../simResults/48/perfectAngles.png")
# plt.figure()
...
for i in range(0,3):
    ...
    ''' dip without ad-ab '''
    startT = time.time()    
    estAng_dip = modD.estimateSeries(b_dip_A, fingList, sensList, jointList, bnds=True, met=i)
    ...
    plt.savefig("../simResults/48/"+str(i)+"dip_nA.png")
    ...
    plt.savefig("../simResults/48/"+str(i)+"cyl_nA.png")

    ''' dip with ad-ab '''
    startT = time.time()
    estAng_dip_A = modDA.estimateSeries(b_dip_A, fingList, sensList, jointList, bnds=True, met=i)
    endT = time.time()-startT
    ...
    plt.savefig("../simResults/48/"+str(i)+"dip_A.png")

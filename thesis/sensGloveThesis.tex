...
\include{texfiles/relatedWork}

\include{texfiles/foundations}

%\include{texfiles/modelAssumptions}

%\include{texfiles/verification}

%\include{texfiles/implementation}

%\include{texfiles/results}

%\include{texfiles/comparison}

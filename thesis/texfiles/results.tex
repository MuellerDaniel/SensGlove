...
\begin{figure}
\subfloat[Nearing the negative pole to the sensor]
{\includegraphics{pictures/plots/negClipping.png} \label{fig:negClip}}
\hfill
\subfloat[Nearing the positive pole to the sensor]
...
\begin{figure}
\centering
\includegraphics{pictures/plots/cali_devi.png}\label{fig:devi}
\caption{\todo{caption!}}
\end{figure}

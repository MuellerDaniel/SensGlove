...
%Several datasets were recorded with the magnetic system and a commercially available vision system, which is assumed to return almost ground truth values for the finger states. The estimated states of a single finger by the developed approach can be reconstructed almost reliably. The overall smallest predicted difference to the vision system is $ 0.467 \si{radian} \pm 0.027 $ (=$ 26.757 \si{\degree} \pm 1.547 $).

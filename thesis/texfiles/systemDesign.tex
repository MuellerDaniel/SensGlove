...
\end{tikzpicture}
\caption{Kinematic chain representation of a single finger. The Cartesian coordinate system is aligned like the sensor. The \ac{MCP} joint lies on the y-Axis}
\label{fig:handMod}
\end{figure}

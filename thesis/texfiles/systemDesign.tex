...
\todo{placement of the MCP/DIP/PIP naming; placement of $ \theta $s; placement of bone lengths; insert $ \phi $ for adduction-abduction}}
\label{fig:handMod}
\end{figure}

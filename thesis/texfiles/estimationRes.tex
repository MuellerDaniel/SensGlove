...
\begin{figure}
\centering
\subfloat{\includegraphics{pictures/statePics/bestLeap/30sec.jpg}}\\
\subfloat{\includegraphics{pictures/statePics/bestLeap/bla.jpg}}
%\caption{mCap}

\subfloat{
\includegraphics{pictures/plots/bestEstTEST.png}
...
\todo{So summarize why the estimated results differ so much from the Leap data}
...
In order to tune and improve the magnetic system for the estimation the hand poses, several methods were evaluated. 
...
\textbf{influence of normed fitting gesture / use fist? and observed fitting values}
	...
	\item \todo{plot magnetic values of 160210\_set1 till second fist and extract pictures for each init gesture to state that 90 fit is more stable!} \\
